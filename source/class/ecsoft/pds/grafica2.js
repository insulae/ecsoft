qx.Class.define("ecsoft.pds.grafica2", {  
  ...
  members :
  {
	setDatos: function(datosGrafica){
		this._datos = datosGrafica;
		this._chart.render();
	},
	mostrarGrafica: function(){
		      
		      this._chart = new CanvasJS.Chart("canvasElement", {
				theme: 'cranks',
				zoomEnabled: true,
				//zoomType: "xy",
				title:{
